package pe.com.relari.fwk.spring.web.employee.dao.impl;
...
import pe.com.relari.fwk.spring.web.employee.dao.mapper.DomainToEntityMapper;
import pe.com.relari.fwk.spring.web.employee.dao.repository.EmployeeRepository;
import pe.com.relari.fwk.spring.web.employee.util.category.ErrorCatalog;
...
public class EmployeeDaoImpl implements EmployeeDao {
    ...
    public Employee findById(Integer id) {
        ...
        return employeeRepository.findById(id)
                .map(DomainToEntityMapper.INSTANCE::mapEmployee)
                .orElseThrow(() ->  new ApiException(ErrorCatalog.EMPLOYEE_NOT_FOUND.name()));
    }
